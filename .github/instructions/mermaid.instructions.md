...
3. Validate syntax: ensure a valid Mermaid diagram type header is present (allow optional frontmatter, directives like `%%{init:...}%%`, and comments before it), plus correct arrow types and balanced brackets.
